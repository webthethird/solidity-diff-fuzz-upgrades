...
contract ExposedComptroller {
    ...
    function _setCloseFactor(uint newCloseFactorMantissa) external returns (uint) {
        return comptroller._setCloseFactor(newCloseFactorMantissa);
    }
    ...
    function _setCollateralFactor(CToken cToken, uint newCollateralFactorMantissa) external returns (uint) {
        return comptroller._setCollateralFactor(cToken, newCollateralFactorMantissa);
    }
    ...
    function _setLiquidationIncentive(uint newLiquidationIncentiveMantissa) external returns (uint) {
        return comptroller._setLiquidationIncentive(newLiquidationIncentiveMantissa);
    }
    ...
    function _supportMarket(CToken cToken) external returns (uint) {
        return comptroller._supportMarket(cToken);
    }
    ...
    function claimComp(address holder) public {
        return comptroller.claimComp(holder);
    }
